...
<html lang="en" dir="ltr">
  ...
  <body class="bookseat" >
    ...
    <div class="book" style="height:40vh;width:30vh;box-shadow:1px 1px 5px 5px green;margin-left:30vw; margin-top:10vh;">


    <form class="tablebook" method="post" >

      <select  name="tid" style="padding:1vh 1vw;">
        <?php
      ...
      <input type="datetime-local" name="bookfor" style="padding:1vh 1vw;">
      <br><br>
