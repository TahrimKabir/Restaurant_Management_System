...
<br>
       ...
       <input type="text" name="desc" placeholder="About the food"><br>
        ...
        //add button
         if (isset($_POST["add"])) {
           ...
           if (mysqli_num_rows($check)==0) {
               $add = mysqli_query($conn,"INSERT INTO food(category,food,price,image,about,add_by) VALUES('$cat','$food','$price','$filename','$desc','$user')");
           }
           else {
