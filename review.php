          ...
          <div class="show" style="margin:20vh;">
            ...
            if (mysqli_num_rows($show)) {
              while ($review=mysqli_fetch_assoc($show)) {
                ...
                echo "<div style='display:inline-block;background:#A7AE9C;border-radius:40px 40px 40px 40px;'>";
                echo "<h3 style='color:white;'><img src='image/$uphoto' height='75' width='75' style='border-radius:50%;padding:0,margin:1vh 1vw;'>".$review['review_by']." <i style='color:blue;'>at</i> ".$review['review_at']."</h3>";

                echo "</div>";
                echo "<div style='margin:0;padding:0;height:auto;width:45.5vw;
border-radius: 10px 10px 10px 10px;background:#34495e;'>";
                echo "<br><br>";
                echo "<div style='height:auto;width:42vw;text-align: justify;background:#34495e;'>";

                echo "<textarea rows='5' cols='84'style='border-style:none;font-family:cursive; background:#34495e; color:white; text-align:center;'>".$review['review']."</textarea>";
                echo "<br>";
                echo "</div>";
                echo "<div>";
