...
require 'customer.php';
 ...
 <html lang="en" dir="ltr">
   ...
   <body style="background:black;">
     ...
     <input type="text" name="" placeholder="search here" id="input" style="float:right;border-color:blue;background-color:transparent;border-radius:16px 16px 16px 16px;color:green; margin-top:3vh;margin-left: 10vw;margin-right:15vw;padding:1vw 1vh;width:79%;"><br><br><br><br>
