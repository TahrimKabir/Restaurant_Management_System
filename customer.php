      ...
      <body >
         <nav  style="height:25vh; background: #059862">
          ...
          <a class="change" href="#"  ><?php
           ...
           <a class="change" href="cart.php">cart <sup style="color: red;"><?php $num = mysqli_query($conn,"SELECT * FROM cart WHERE cart_by='$user_logged_in'");
              echo mysqli_num_rows($num);?></sup> </a>
           <a class="change"><?php echo $_SESSION["vemail"]; ?></a>
           <a href="#" class="change"><form class="submit" method="post">
